...
//            }
//
//            if (link.toLowerCase().indexOf("<a href="http://lib.csdn.net/base/18" class='replace_word' title="JavaScript知识库" target='_blank' style='color:#df3434; font-weight:bold;'>JavaScript</a>") != -1) {
//            continue;
//        }
//        if (link.indexOf("://") == -1){
